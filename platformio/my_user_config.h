...
#define CFG_HOLDER             30000              // [Reset 1] Change this value (max 32000) to load SECTION1 configuration parameters to flash

// -- Project -------------------------------------
#define PROJECT                "door_office"          // PROJECT is used as the default topic delimiter
...
// -- Wifi ----------------------------------------
#define WIFI_IP_ADDRESS        "192.168.86.191"  // [IpAddress1] Set to 0.0.0.0 for using DHCP or IP address
#define WIFI_GATEWAY           "192.168.86.1"    // [IpAddress2] If not using DHCP set Gateway IP address
#define WIFI_SUBNETMASK        "255.255.255.0"   // [IpAddress3] If not using DHCP set Network mask
#define WIFI_DNS               "192.168.86.1"    // [IpAddress4] If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)

#define STA_SSID1              "dienernets"                // [Ssid1] Wifi SSID
...
#define MQTT_HOST              "192.168.86.27"   // [MqttHost]
...
#define MQTT_USER              "SG_username"     // [MqttUser] MQTT user
...
#define FRIENDLY_NAME          "Office Door"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
